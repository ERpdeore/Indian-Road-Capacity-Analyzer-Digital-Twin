@echo off
REM ============================================================
REM Double-click this file to generate the IDEAL (no-defects) 3D
...
echo Launching MATLAB and RoadRunner for the IDEAL road...
echo (this window will stay open while the simulation runs -- close it when done)
echo.

"%MATLAB_EXE%" -sd "%SCRIPT_DIR%" -r "auto_import_roadrunner('ideal')"
